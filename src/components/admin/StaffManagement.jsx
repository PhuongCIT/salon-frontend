...
const StaffManagement = () => {
  ...
  const [itemsPerPage] = useState(4); // Số item mỗi trang
  ...
  return (
    <div className="bg-white shadow-md rounded-lg p-2 dark:bg-gray-700 dark:text-white">
          ...
          <tbody>
            {currentStaffs.map((staff, index) => (
              ...
              >
                ...
                <td className="border border-gray-300 px-4 py-2">
                  <button
                    className="bg-red-500 text-white cursor-pointer ml-3 rounded px-1 "
        ...
        <div className="flex space-x-2">
          <button
            ...
            className={`px-4 py-2 rounded-lg border ${
              currentPage === 1
                ? "bg-gray-200 cursor-not-allowed dark:bg-gray-500"
                : "bg-white hover:bg-gray-100 dark:hover:bg-gray-600"
            }`}
          >
            Previous
          </button>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-lg border ${
                currentPage === number
                  ...
                  : "bg-white hover:bg-gray-100 dark:bg-gray-500 dark:hover:bg-gray-600"
              }`}
            >
              {number}
            </button>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-lg border ${
              currentPage === totalPages
                ? "bg-gray-200 cursor-not-allowed dark:bg-gray-500"
                : "bg-white hover:bg-gray-100 dark:bg-gray-500"
            }`}
          >
            Next
          </button>
